...
public class ShowReadingTestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_reading_tests);

        listView = findViewById(R.id.idReadingPastTests);
        average = findViewById(R.id.averageReading);
        ...
        documentReference.addSnapshotListener((value, error) -> {
            ...
            try {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ShowReadingTestsActivity.this, android.R.layout.simple_list_item_1, entry);
