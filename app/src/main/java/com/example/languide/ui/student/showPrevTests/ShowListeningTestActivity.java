...
public class ShowListeningTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_listening_test);

        listView = findViewById(R.id.idListeningPastTests);
        average = findViewById(R.id.averageListening);
        ...
        documentReference.addSnapshotListener((value, error) -> {
            ...
            try {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ShowListeningTestActivity.this, android.R.layout.simple_list_item_1, entry);
