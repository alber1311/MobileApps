...
public class ShowVocabularyTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_vocabulary_test);

        listView = findViewById(R.id.idVocabularyPastTests);
        average = findViewById(R.id.averageVocabulary);
        ...
        documentReference.addSnapshotListener((value, error) -> {
            ...
            try {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ShowVocabularyTestActivity.this, android.R.layout.simple_list_item_1, entry);
