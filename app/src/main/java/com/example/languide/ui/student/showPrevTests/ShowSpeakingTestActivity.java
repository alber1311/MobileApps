...
public class ShowSpeakingTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_speaking_test);

        listView = findViewById(R.id.idSpeakingPastTests);
        average = findViewById(R.id.averageSpeaking);
        ...
        documentReference.addSnapshotListener((value, error) -> {
            ...
            try {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ShowSpeakingTestActivity.this, android.R.layout.simple_list_item_1, entry);
